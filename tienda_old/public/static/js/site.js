                    ...
                    div += "<div class=\"image\">"
                        div += "<div class=\"overlay\">";
                            div += "<div class=\"btns\">";
                                ...
                                div += "<a href=\""+base+"/product/"+product.id+"/"+product.slug+"\"><i class=\"fas fa-cart-plus\"></i></a>";
                                if(auth == 1){
                                    div += "<a href=\"#\" id=\"favorite_1_"+product.id+"\" onclick=\"add_to_favorites('"+product.id+"', '1'); return false;\"><i class=\"fas fa-heart\"></i></a>";
                                }else{
                                    div += "<a href=\"#\" id=\"favorite_1_"+product.id+"\" onclick=\"Swal.fire({title: 'Ooops....', text: 'Para agregar a favoritos, ingresa a tu cuenta', icon: 'warning'}); return false;\"><i class=\"fas fa-heart\"></i></a>";
                                }
...
function product_single_amount(action){
    ...
    var new_quantity = quantity.value;
...
function delete_object(e){
    ...
    if(action == "delete"){
        title = "¿Esta seguro de eliminar este objeto?";
